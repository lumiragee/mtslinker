...
- берёт трансляцию экрана как картинку (камеры участников не накладывает поверх неё), а когда экрана нет, ставит чёрный кадр;
- смешивает звук всех микрофонов;
- ставит каждый кусок на своё время, включая потоки, которые начались до старта записи;
